  ...
  settingNav: [
    {
      ...
      items: [
        ...
        { title: "User Role", url: "/admin/user-roles", icon: UserCog },
        ...
        { title: "Group Rights", url: "/admin/group-rights", icon: Shield },
        { title: "Report Rights", url: "/admin/report-rights", icon: PieChart },
