...
import { IArCreditNoteDt, IArCreditNoteHd } from "@/interfaces"
...
export default function EditVersionDetails({
  ...
  const { data: creditNoteHistoryData, refetch: refetchHistory } =
    ...
    useGetAPCreditNoteHistoryList<IArCreditNoteHd[]>(creditNoteId)

  const { data: creditNoteDetailsData, refetch: refetchDetails } =
    useGetAPCreditNoteHistoryDetails<IArCreditNoteHd>(
  ...
  const detailsColumns: ColumnDef<IArCreditNoteDt>[] = [
