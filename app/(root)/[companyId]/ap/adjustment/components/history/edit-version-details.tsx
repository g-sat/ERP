...
import { IApAdjustmentDt, IApAdjustmentHd } from "@/interfaces/ap-adjustment"
...
export default function EditVersionDetails({
  ...
  const detailsColumns: ColumnDef<IApAdjustmentDt>[] = [
        ...
        <CardContent>
          ...
          {hasHistoryError && (
            ...
            >
              ...
              <AlertDescription>
                {adjustmentHistoryData?.message === "Data does not exist"
                  ? "No adjustment history found for this adjustment."
                  : `Failed to load adjustment history: ${adjustmentHistoryData?.message || "Unknown error"}`}
              </AlertDescription>
            </Alert>
          )}
          <DialogDataTable
        ...
        <DialogContent className="@container h-[80vh] w-[90vw] !max-w-none overflow-y-auto rounded-lg p-4">
          ...
          {hasDetailsError && (
            ...
            >
              ...
              <AlertDescription>
                {adjustmentDetailsData?.message === "Data does not exist"
                  ? "No adjustment details found for this version."
                  : `Failed to load adjustment details: ${adjustmentDetailsData?.message || "Unknown error"}`}
              </AlertDescription>
            </Alert>
          )}
            ...
            <Card>
              ...
              <CardContent>
                <BasicTable
                  ...
                  moduleId={moduleId}
                  transactionId={transactionId}
                  tableName={TableName.apAdjustmentHistory}
                  emptyMessage="No adjustment details available"
                  onRefresh={handleRefresh}
                  showHeader={true}
                  showFooter={false}
                  maxHeight="300px"
