...
export default function PaymentForm({
  ...
  const recalculateHeaderTotals = React.useCallback(() => {
    ...
    const totals = calculateTotalAmounts(
      formDetails as unknown as IApRefundDt[],
      amtDec
    )
  ...
  const handleCurrencyChange = React.useCallback(
    async (selectedCurrency: ICurrencyLookup | null) => {
      ...
      if (currencyId && accountDate) {
        ...
        form.setValue(
          "data_details",
          updatedDetails as unknown as ApRefundDtSchemaType[],
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        ...
        {/* Cheque No - Only show when refund type is cheque */}
        {isChequePayment && (
          <CustomInput
            form={form}
            name="chequeNo"
        ...
        {/* Cheque Date - Only show when refund type is cheque */}
        {isChequePayment && (
          <CustomDateNew
            form={form}
            name="chequeDate"
