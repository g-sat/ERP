        ...
        <div className="grid grid-cols-7 items-end gap-2">
          <div className="space-y-2">
            ...
            >
              ...
              <option value="outstanding">Outstanding Payables</option>
              <option value="ledger">Supplier Ledger</option>
              <option value="aging">Aging Analysis</option>
              <option value="collection">Payment Projection</option>
              <option value="credit">Supplier Credit Limit Report</option>
              <option value="sales">Purchase Analysis</option>
          ...
          <div className="space-y-2">
            ...
            <CompanySupplierAutocomplete
              form={form}
              name="supplier"
              onChangeEvent={(supplier) => {
                form.setValue("supplier", supplier?.supplierName || "")
              }}
              className="w-full"
            />
          </div>
