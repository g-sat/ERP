...
const REPORT_CATEGORIES = [
  ...
  },
  {
    ...
    reports: [
      {
        id: "ap-supplier-ledger",
        name: "AP Supplier Ledger",
        reportFile: "ArSupplierLedger.trdp",
      },
      {
...
export default function ReportsPage() {
  ...
  const handleViewReport = (data: IReportFormData) => {
    ...
    selectedReportObjects.forEach((report) => {
      ...
      const reportFile =
        report.id === "ap-supplier-ledger"
          ? "ArSupplierLedger.trdp"
          : report.reportFile
      ...
      const reportParams =
        report.id === "ap-supplier-ledger"
          ? {
              ...
              supplierId: parameters.supplierId || 1107,
