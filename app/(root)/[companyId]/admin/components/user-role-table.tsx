...
interface UserRoleTableProps {
  data: IUserRole[]
  isLoading?: boolean
  onUserRoleSelect?: (role: IUserRole | undefined) => void
  onDeleteUserRole?: (roleId: string) => void
  onEditUserRole?: (role: IUserRole) => void
...
export function UserRoleTable({
  ...
  const columns: ColumnDef<IUserRole>[] = [
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <TableActions
            row={role}
            idAccessor="userRoleId"
            onView={onUserRoleSelect}
  ...
  const handleSearch = (query: string) => {
    ...
    if (data && data.length > 0) {
      ...
      const newFilters: IUserRoleFilter = {
        search: query,
            ...
            {virtualRows.length > 0 ? (
              ...
              <>
                <TableRow>
                  ...
                  >
                    {isLoading ? "Loading..." : "No user roles found."}
                  </TableCell>
                </TableRow>
