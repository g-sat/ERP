...
interface TaxCategoryTableProps {
  data: ITaxCategory[]
  isLoading?: boolean
  onTaxCategorySelect?: (taxdtcategory: ITaxCategory | null) => void
  onDeleteTaxCategory?: (taxId: string) => void
  onEditTaxCategory?: (taxdtcategory: ITaxCategory) => void
  onCreateTaxCategory?: () => void
  onRefresh?: () => void
  ...
  const columns: ColumnDef<ITaxCategory>[] = [
    {
      ...
      cell: ({ row }) => (
        <TableActions
          row={row.original}
          idAccessor="taxCategoryId"
          onView={onTaxCategorySelect}
          onEdit={onEditTaxCategory}
          onDelete={onDeleteTaxCategory}
        />
      ),
    },
    {
  ...
  return (
    <div>
      <TableHeader
        ...
        moduleId={moduleId || 1}
        transactionId={transactionId || MasterTransactionId.tax_category}
        companyId={companyId}
      />
