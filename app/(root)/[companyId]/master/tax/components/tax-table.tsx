...
import { ITax, ITaxFilter } from "@/interfaces/tax"
...
interface TaxTableProps {
  data: ITax[]
  isLoading?: boolean
  onTaxSelect?: (tax: ITax | null) => void
  onDeleteTax?: (taxId: string) => void
  onEditTax?: (tax: ITax) => void
  onCreateTax?: () => void
  onRefresh?: () => void
...
export function TaxTable({
  ...
  const columns: ColumnDef<ITax>[] = [
    ...
    },
    {
      ...
      header: "Code",
      cell: ({ row }) => (
        <div className="font-medium">{row.getValue("taxCode")}</div>
      ),
      size: 120,
      minSize: 50,
      maxSize: 150,
    ...
    },
    {
      ...
      header: "Category",
      cell: ({ row }) => (
        <div className="font-medium">{row.getValue("taxCategoryName")}</div>
      ),
      size: 120,
      minSize: 50,
      maxSize: 150,
  ...
  return (
    <div>
      <TableHeader
        ...
        moduleId={moduleId || 1}
        transactionId={transactionId || MasterTransactionId.tax}
      />
