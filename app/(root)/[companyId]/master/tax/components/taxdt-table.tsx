...
interface TaxDtTableProps {
  data: ITaxDt[]
  isLoading?: boolean
  onTaxDtSelect?: (taxdt: ITaxDt | null) => void
  onDeleteTaxDt?: (taxId: string) => void
  onEditTaxDt?: (taxdt: ITaxDt) => void
  onCreateTaxDt?: () => void
  onRefresh?: () => void
  ...
  const columns: ColumnDef<ITaxDt>[] = [
    {
      ...
      cell: ({ row }) => (
        <TableActions
          row={row.original}
          idAccessor="taxId"
          onView={onTaxDtSelect}
          onEdit={onEditTaxDt}
          onDelete={onDeleteTaxDt}
        />
      ),
    },
    {
