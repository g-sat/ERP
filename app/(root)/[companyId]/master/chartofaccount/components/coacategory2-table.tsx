...
interface CoaCategory2TableProps {
  data: ICoaCategory2[]
  isLoading?: boolean
  onCoaCategory2Select?: (category: ICoaCategory2 | null) => void
  onDeleteCoaCategory2?: (id: string) => void
  onEditCoaCategory2?: (category: ICoaCategory2) => void
  onCreateCoaCategory2?: () => void
  onRefresh?: () => void
...
export function CoaCategory2Table({
  ...
  const columns: ColumnDef<ICoaCategory2>[] = [
    {
      ...
      cell: ({ row }) => (
        <TableActions
          ...
          onView={onCoaCategory2Select}
          onEdit={onEditCoaCategory2}
          onDelete={onDeleteCoaCategory2}
        />
      ),
    },
    {
  ...
  const handleSearch = (query: string) => {
    ...
    if (data && data.length > 0) {
      ...
      const newFilters: ICoaCategory2Filter = {
        search: query,
  ...
  useEffect(() => {
    if (!data?.length && onFilterChange) {
      const filters: ICoaCategory2Filter = {
        search: searchQuery,
        sortOrder: sorting[0]?.desc ? "desc" : "asc",
      }
  ...
  return (
    <div>
      <TableHeader
        ...
        onRefresh={onRefresh}
        onCreate={onCreateCoaCategory2}
        columns={table.getAllLeafColumns()}
        data={data}
        tableName={TableName.coa_category2}
