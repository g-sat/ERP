...
import { IGstCategory, IGstFilter } from "@/interfaces/gst"
...
interface GstCategoryTableProps {
  data: IGstCategory[]
  isLoading?: boolean
  onGstCategorySelect?: (gstdtcategory: IGstCategory | null) => void
  onDeleteGstCategory?: (gstId: string) => void
  onEditGstCategory?: (gstdtcategory: IGstCategory) => void
  onCreateGstCategory?: () => void
  onRefresh?: () => void
  ...
  const columns: ColumnDef<IGstCategory>[] = [
    {
      ...
      cell: ({ row }) => (
        <TableActions
          row={row.original}
          idAccessor="gstCategoryId"
          onView={onGstCategorySelect}
          onEdit={onEditGstCategory}
          onDelete={onDeleteGstCategory}
        />
      ),
    },
    {
  ...
  return (
    <div>
      <TableHeader
        ...
        onRefresh={onRefresh}
        onCreate={onCreateGstCategory}
        columns={table.getAllLeafColumns()}
        data={data}
        tableName={TableName.gst_category}
        hideCreateButton={false}
        moduleId={moduleId || ModuleId.master}
        transactionId={transactionId || MasterTransactionId.gst_category}
      />
