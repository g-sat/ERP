...
import { IGst, IGstFilter } from "@/interfaces/gst"
...
interface GstTableProps {
  data: IGst[]
  isLoading?: boolean
  onGstSelect?: (gst: IGst | null) => void
  onDeleteGst?: (gstId: string) => void
  onEditGst?: (gst: IGst) => void
  onCreateGst?: () => void
  onRefresh?: () => void
...
export function GstTable({
  ...
  const columns: ColumnDef<IGst>[] = [
    ...
    },
    {
      ...
      header: "Code",
      cell: ({ row }) => (
        <div className="font-medium">{row.getValue("gstCode")}</div>
      ),
      size: 120,
      minSize: 50,
      maxSize: 150,
    ...
    },
    {
      ...
      header: "Category",
      cell: ({ row }) => (
        <div className="font-medium">{row.getValue("gstCategoryName")}</div>
      ),
      size: 120,
      minSize: 50,
      maxSize: 150,
  ...
  return (
    <div>
      <TableHeader
        ...
        onRefresh={onRefresh}
        onCreate={onCreateGst}
        columns={table.getAllLeafColumns()}
        data={data}
        tableName={TableName.gst}
        hideCreateButton={false}
        moduleId={moduleId || ModuleId.master}
        transactionId={transactionId || MasterTransactionId.gst}
        companyId={companyId}
      />
