...
import { IGstDt, IGstFilter } from "@/interfaces/gst"
...
interface GstDtTableProps {
  data: IGstDt[]
  isLoading?: boolean
  onGstDtSelect?: (gstdt: IGstDt | null) => void
  onDeleteGstDt?: (gstId: string) => void
  onEditGstDt?: (gstdt: IGstDt) => void
  onCreateGstDt?: () => void
  onRefresh?: () => void
  ...
  const columns: ColumnDef<IGstDt>[] = [
    {
      ...
      cell: ({ row }) => (
        <TableActions
          row={row.original}
          idAccessor="gstId"
          onView={onGstDtSelect}
          onEdit={onEditGstDt}
          onDelete={onDeleteGstDt}
        />
      ),
    },
    {
