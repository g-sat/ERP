...
interface CurrencyLocalDtsTableProps {
  ...
  isLoading?: boolean
  onCurrencyLocalDtSelect?: (localDt: ICurrencyLocalDt | undefined) => void
  onDeleteCurrencyLocalDt?: (id: string) => void
  onEditCurrencyLocalDt?: (localDt: ICurrencyLocalDt) => void
  onCreateCurrencyLocalDt?: () => void
  onRefresh?: () => void
  onFilterChange?: (filters: ICurrencyLocalDtFilter) => void
  moduleId?: number
      ...
      cell: ({ row }) => {
        ...
        return (
          <TableActions
            ...
            onView={onCurrencyLocalDtSelect}
            onEdit={onEditCurrencyLocalDt}
            onDelete={onDeleteCurrencyLocalDt}
          />
        )
      },
    },
  ...
  return (
    <div>
      <TableHeader
        ...
        onRefresh={onRefresh}
        onCreate={onCreateCurrencyLocalDt}
