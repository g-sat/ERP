    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Enter a descriptive name for the payroll period
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Optional notes about this payroll period
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              <div className="space-y-0.5">
                <FormLabel className="text-base">Active Period</FormLabel>
                <FormDescription>
                  Enable this period for payroll processing
                </FormDescription>
              </div>
              <FormControl>
                <Switch
        ...
        <div className="flex justify-end space-x-2">
          ...
          <Button type="submit">
            {initialData ? "Update Period" : "Create Period"}
          </Button>
        </div>
      </form>
    </Form>
